...
//     registered: "2016-08-21T10:08:24-03:00",
//   },
//   {
...
// const nameUsers = users.map((user) => ({ name: user.name, age: user.age }));
...
// sort -изменяет исходный массив, сортирует по умолчанию по лексическому значению, как строки.

// const strArr = ["Midhat", "Ruslat", "Annya"];
// strArr.sort();
// const numArr = [10, 5, 6, 44, 32];
